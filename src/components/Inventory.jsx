                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden relative animate-[settingsSlideIn_0.3s_ease-out] flex flex-col max-h-[90vh]">
                        ...
                        <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col h-full min-h-0">
                            ...
                            <div className="p-4 border-t border-slate-200 bg-slate-50 flex justify-end gap-3 shrink-0">
                                <button type="button" className="px-5 py-2.5 bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 font-bold rounded-xl transition-colors text-sm" onClick={() => setShowModal(false)} disabled={uploading}>Batal</button>
                                <button type="submit" disabled={uploading} className="px-6 py-2.5 bg-maroon-primary hover:bg-maroon-dark text-white font-bold rounded-xl transition-all shadow-md shadow-maroon-primary/20 active:scale-95 disabled:opacity-50 text-sm flex items-center justify-center gap-2">
